...
const url = "http://18.231.188.155/api";
...
//Tasks
	...
	create_task(token, new_task, task_parent){

		var promise = axios.post(url + '/create_task', { new_task: new_task, task_parent: task_parent}, {headers: {"Authorization" : `Bearer ${token}`}} ).then(response => { return response.data });
